...
#define DEFAULT_CLIENT_CONNECTIONS  100000     // Number of connections to initiate
...
char *gBindAddr    = NULL,              // local interface to bind to
     *gServerAddr  = "192.168.1.34",              // Server address to connect to
     *gBindPort    = "4567";            // local port to bind to
...
HANDLE CreateTempFile(char *filename, DWORD size)
{
    ...
    {
        fprintf(stderr, _T("CreateTempFile failed: %d\n"), GetLastError());
        return hFile;
    }
